...
%Substitute delta =ph-yaw by substitung yaw=ph-delta
MeasEqs=subs(MeasEqs,yaw,ph-delta)
%Calculate Jacobian w.r.t. ph,r, delta
J=simplify(expand(jacobian(MeasEqs,[ph,r,delta])), 'IgnoreAnalyticConstraints', true, 'Steps', 50)
%substitute values derived from the assumption r=r0
J=subs(J,[delta, d_yaw,dd_yaw],[-pi/2,1/r,0])
J=subs(J,[r],[r0])
